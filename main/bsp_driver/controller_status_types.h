...
typedef enum {
    FACTORY_MAINS_PROFILE_220V_50HZ_CCC = 0,
    FACTORY_MAINS_PROFILE_220V_60HZ     = 1,
    FACTORY_MAINS_PROFILE_230V_50HZ_CE = 2,
    FACTORY_MAINS_PROFILE_110V_50HZ     = 3,
    FACTORY_MAINS_PROFILE_110V_60HZ     = 4,
    FACTORY_MAINS_PROFILE_120V_60HZ_UL = 5,
} factory_mains_profile_t;
